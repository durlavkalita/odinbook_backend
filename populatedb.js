...
function userCreate(firstName, lastName, password, profilePhoto, friends, posts, comments, cb) {
    ...
    if (friends != false) userDetail.friends = friends
...
function postCreate(content, author, comments, likes) {
    postDetail = {content: content, author: author}

    if (comments != false) postDetail.comments = comments;
    if (likes != false) postDetail.likes = likes;
...
function commentCreate(content, author, post) {
    commentDetail = {content: content, author: author, post: post}
